...
public class VLayoutInputsSectionMixin extends VLayoutComplexBodyMixin implements NavigatablePsiElement, VLayoutSelfAnnotating {
    public VLayoutInputsSectionMixin(@NotNull ASTNode node) {
        super(node);
    }
