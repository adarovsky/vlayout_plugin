...
public class VLayoutTypesSectionMixin extends VLayoutComplexBodyMixin implements NavigatablePsiElement, VLayoutSelfAnnotating {
    public VLayoutTypesSectionMixin(@NotNull ASTNode node) {
        super(node);
    }
